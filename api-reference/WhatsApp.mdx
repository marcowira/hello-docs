...
<CardGroup cols={2}>
  <Card title="WhatsApp Flows" icon="arrow-progress" href="">
    Learn how to create rich and engaging experiences for customers with WhatsApp Flows.
  </Card>

  <Card title="Meta AI Business Agent" icon="microchip-ai" href="">
